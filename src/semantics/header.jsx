...
const Header = ({onMenuClick,handleFilter}) => {
  ...
  return (
    ...
    <header className="w-full flex justify-between items-center gap-[1.95rem] p-4 md:px-[1.95rem] md:py-[0.75rem] transition duration-50">
      ...
      {/* Middle: Search */}
      <div className="middle hidden md:flex flex-1/2 justify-end items-center gap-4">
        <div className="input-group flex justify-end items-center gap-[1.125rem] w-full">
          ...
          <button className="bg-gradient-to-br from-(--bg-pink) to-(--bg-color) text-white rounded-[3rem] py-[12px] px-8">
            Search
          </button>
        </div>
        <button className="filter bg-white p-[10px] rounded-full grid content-center cursor-pointer hover:bg-gray-100" onClick={handleFilter}>
